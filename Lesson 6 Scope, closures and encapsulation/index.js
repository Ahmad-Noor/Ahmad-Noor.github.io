(function() {
    ...
    var stringAssert = function() {
        var str = "AhmedTestAltaher";
        var expected = "AhmedAltaher";
    ...
    var studentAssert = function() {
        var me = new Student();
        me.initialize("Ahmed", 33);
        var found = me.learn("Inheritance");
        var expected = 'Ahmed just learned Inheritance';
    ...
    var teacherAssert = function() {
        var me = new Teacher();
        me.initialize("Alaa", 35);
        var found = me.teach("WAP");
        var expected = 'Alaa is now teaching WAP';
